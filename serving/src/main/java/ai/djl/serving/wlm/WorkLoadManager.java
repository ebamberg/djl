...
public class WorkLoadManager {
	...
	public WorkLoadManager() {
		...
		defaultPredictionExecutor	=	new ThreadPoolExecutor(0, 5,
	...
	public void registerSpecialisedExecutorForModel(ModelInfo model) {
		...
		specialisedPredictionExecutor.put(model.getModelName(), 
				new ThreadPoolExecutor(model.getMinWorkers(), model.getMaxWorkers(),
                model.getMaxBatchDelay(), TimeUnit.SECONDS,
                new SynchronousQueue<Runnable>()));
	}
