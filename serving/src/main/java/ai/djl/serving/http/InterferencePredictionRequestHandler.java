...
public class InterferencePredictionRequestHandler extends HttpRequestHandler {
    ...
    private static final Logger logger = LoggerFactory.getLogger(InterferencePredictionRequestHandler.class);

    private static final Pattern PATTERN =
            Pattern.compile("^/predictions([/?].*)?");
    ...
    protected void handleRequest(
        ...
        predictionService.predict(input, segments[2])
	        .exceptionally( t -> {
	        	// TODO refactor: this can return ErrorResponseObject and then Accepts can handle this error-object as a normal result. to clarify: how to set the status
