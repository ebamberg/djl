...
public class ServerInitializer extends ChannelInitializer<Channel> {
    ...
    public void initChannel(Channel ch) {
        ...
        WorkLoadManager executorProvider=ModelManager.getInstance().getWorkLoadManager();
        ModelLoadService modelLoadService=new ModelLoadService();
        PredictionService predictionService=new PredictionService(executorProvider,modelLoadService);
        ...
        switch (connectorType) {
            ...
            case INFERENCE:
                ...
                pipeline.addLast("prediction", new InterferencePredictionRequestHandler(predictionService) );
                break;
            case BOTH:
            default:
                pipeline.addLast("inference", new InferenceRequestHandler(predictionService));
